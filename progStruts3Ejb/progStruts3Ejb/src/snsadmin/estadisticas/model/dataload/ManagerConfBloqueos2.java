...
public class ManagerConfBloqueos2 {


  public ManagerConfBloqueos2() {
  }


  public Salida getConfigurationData(ReportFileBean reportFileBean, String initialDate, String finalDate) {

    Salida salida = new Salida ();

    Logger logger = new Logger("snsadmin.estadisticas.model.dataload.ManagerConfigurationBloqueos2.getConfigurationData");

    try {
      logger.debug("INICIO");

      // Rellena la informacion de las tablas
      this.getBloqueos(reportFileBean, initialDate, finalDate);
  ...
  private Salida getBloqueos(ReportFileBean reportFileBean, String initialDate, String finalDate) {

    Salida salida = new Salida();
    Logger logger = new Logger("snsadmin.estadisticas.model.dataload.ManagerConfigurationBloqueos2.getBloqueos");
  ...
  private Salida getTablaPorTipo(String initialDate, String finalDate) {
    ...
    Salida salida = new Salida();
    Logger logger = new Logger("snsadmin.estadisticas.model.dataload.ManagerConfigurationBloqueos2.getTablaPorTipo");
    ...
    try {
      ...
      strQuery.append(" where r.FECHA_OPERACION between to_date(?,'dd-mm-yyyy') ");
      strQuery.append(" and to_date(?,'dd-mm-yyyy')+1 ");
      strQuery.append(" and (r.COD_TIPO_OPERACION in ('A001','A005','N001','N002','N004','N005','N007','N008','N009','N010') ");
  ...
  private Salida getTablaN00x(String initialDate, String finalDate) {
    ...
    Salida salida = new Salida();
    Logger logger = new Logger("snsadmin.estadisticas.model.dataload.ManagerConfigurationBloqueos2.getTablaN00x");
    ...
    try {
      ...
      tableBean.setTipo("");
      // Numero de la fila de la cabecera
      tableBean.setNumFilaCabecera(8);
      // Numero de la fila inicial de la tabla
      tableBean.setNumFilaInicial(9);
      //
      // Consulta
      StringBuffer strQuery = new StringBuffer();
