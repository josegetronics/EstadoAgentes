        ...
        <tr>
          <td>
            <table border="0" align="center" cellspacing="3" width="100%">
              ...
              <!-- -->
                ...
                <html:hidden  property="option" value="-1"/>
 		...
 		<tr>
                  <td colspan="4" align="center">
                  	<html:button property="boton" value="reporting" onclick="javascript:pushButton('1')" />
                  </td>
                </tr>
 		...
 		<tr>
                  <td colspan="4" align="center">
                  	<html:button property="boton" value="historico" onclick="javascript:pushButton('2')" />
                  </td>
                </tr>
