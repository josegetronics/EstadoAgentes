...
public class NombreHelper {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			//
			//
			//String nombre           = "JOSE MANUEL ANTONIO";
			//String nombreComparar   = "JOSE MIGUEL ANTONIO";
			//NombreComparacionBean nombreComparacionBean = new NombreComparacionBean (nombre, nombreComparar);
			//nombreHelper.managerNombre(nombreComparacionBean);
			//
			String path           = "D:/Procesos/BusquedaAproximacion/2014-01-16  Pais Vasco/Estudio Gemelos/00/";
			String ficheroDestino = "fichero.txt";
			nombreHelper.manager(path, ficheroDestino);
			
			//nombreHelper.obtenerConsonantes ("ANTONIO");
			
			//
			// comprobar primera letra igual
			// comprobar mismo numero de vocales
			// comprobar mismo numero de consonantes
	...
	public void manager(String path, String ficheroDestino) throws Exception {
		...
		try {
            ...
            stringBuffer.append(" select C.NOMBRE, C.NOMBRE_BUS  ");
            stringBuffer.append(" from   CRUCE_CA_SNS_INSS_REV c ");
            //stringBuffer.append(" where  rownum < 10001  ");
			...
			while (resultSet.next()) {
				...
				String nombreComparar = Misc.nz(resultSet.getString("NOMBRE_BUS"));
				//				
				NombreComparacionBean nombreComparacionBean = new NombreComparacionBean (nombre, nombreComparar);
				this.managerNombre(nombreComparacionBean);
				//
				//
				StringBuffer str = new StringBuffer ();
				//
				str.append(nombreComparacionBean.getNombreOriginal_1()             + ConstantesBusqueda.SEPARADOR_CAMPOS);
				str.append(nombreComparacionBean.getNombre_1()                     + ConstantesBusqueda.SEPARADOR_CAMPOS);
				str.append(nombreComparacionBean.getNombre_1().length()            + ConstantesBusqueda.SEPARADOR_CAMPOS);
				//
				str.append(nombreComparacionBean.getNombreOriginal_2()             + ConstantesBusqueda.SEPARADOR_CAMPOS);
				str.append(nombreComparacionBean.getNombre_2()                     + ConstantesBusqueda.SEPARADOR_CAMPOS);
				str.append(nombreComparacionBean.getNombre_2().length()            + ConstantesBusqueda.SEPARADOR_CAMPOS);
				//
				str.append(nombreComparacionBean.getContadorPosicionIguales_1()    + ConstantesBusqueda.SEPARADOR_CAMPOS);
				str.append(nombreComparacionBean.getPorcentajePosicionIguales_1()  + ConstantesBusqueda.SEPARADOR_CAMPOS);
				str.append(nombreComparacionBean.getContadorLetrasIguales_1()      + ConstantesBusqueda.SEPARADOR_CAMPOS);
				str.append(nombreComparacionBean.getPorcentajeLetrasIguales_1()    + ConstantesBusqueda.SEPARADOR_CAMPOS);
				//
				str.append(nombreComparacionBean.getContadorPosicionIguales_2()    + ConstantesBusqueda.SEPARADOR_CAMPOS);
				str.append(nombreComparacionBean.getPorcentajePosicionIguales_2()  + ConstantesBusqueda.SEPARADOR_CAMPOS);
				str.append(nombreComparacionBean.getContadorLetrasIguales_2()      + ConstantesBusqueda.SEPARADOR_CAMPOS);
				str.append(nombreComparacionBean.getPorcentajeLetrasIguales_2()    + ConstantesBusqueda.SEPARADOR_CAMPOS);
				//
				str.append(nombreComparacionBean.getContadorPosicionIguales()      + ConstantesBusqueda.SEPARADOR_CAMPOS);
				str.append(nombreComparacionBean.getPorcentajePosicionIguales()    + ConstantesBusqueda.SEPARADOR_CAMPOS);
				str.append(nombreComparacionBean.getContadorLetrasIguales()        + ConstantesBusqueda.SEPARADOR_CAMPOS);
				str.append(nombreComparacionBean.getPorcentajeLetrasIguales()      + ConstantesBusqueda.SEPARADOR_CAMPOS);
				//
				//
				// Consonantes
				str.append(nombreComparacionBean.getCadenaConsonantes1()             + ConstantesBusqueda.SEPARADOR_CAMPOS);
				str.append(nombreComparacionBean.getCadenaConsonantes2()             + ConstantesBusqueda.SEPARADOR_CAMPOS);
				//
				str.append(nombreComparacionBean.getContadorConsonantesOrden_1()     + ConstantesBusqueda.SEPARADOR_CAMPOS);
				str.append(nombreComparacionBean.getContadorConsonantesOrden_2()     + ConstantesBusqueda.SEPARADOR_CAMPOS);
				str.append(nombreComparacionBean.getPorcentajeConsonantesOrden_1()   + ConstantesBusqueda.SEPARADOR_CAMPOS);
				str.append(nombreComparacionBean.getPorcentajeConsonantesOrden_2()   + ConstantesBusqueda.SEPARADOR_CAMPOS);
				str.append(nombreComparacionBean.getPorcentajeConsonantesOrden()     + ConstantesBusqueda.SEPARADOR_CAMPOS);
				//
				str.append(nombreComparacionBean.getContadorConsonantesIguales_1()   + ConstantesBusqueda.SEPARADOR_CAMPOS);
				str.append(nombreComparacionBean.getContadorConsonantesIguales_2()   + ConstantesBusqueda.SEPARADOR_CAMPOS);
				str.append(nombreComparacionBean.getPorcentajeConsonantesIguales_1() + ConstantesBusqueda.SEPARADOR_CAMPOS);
				str.append(nombreComparacionBean.getPorcentajeConsonantesIguales_2() + ConstantesBusqueda.SEPARADOR_CAMPOS);
				str.append(nombreComparacionBean.getPorcentajeConsonantesIguales()   + ConstantesBusqueda.SEPARADOR_CAMPOS);
				//
				str.append(nombreComparacionBean.getConsonantesInclusion()           + ConstantesBusqueda.SEPARADOR_CAMPOS);
				//
				// La primera Letra es Igual
				str.append(nombreComparacionBean.getPrimeraLetraIgual()              + ConstantesBusqueda.SEPARADOR_CAMPOS);
				//
				// Encontrado
				str.append(nombreComparacionBean.getRevisionInt()                     + ConstantesBusqueda.SEPARADOR_CAMPOS);
				//
				//
				str.append("\n");
				//
	...
	public void managerNombre(NombreComparacionBean nombreComparacionBean) throws Exception {
		//
		String nombre         = "";
		...
		try {
			...
			if(Misc.esVacio(nombre) && Misc.esVacio(nombreComparar)) {
				// Se identifica como Igual misma persona
